...
const Dashboard = () => {
  const [dashboardDate, setDashboardDate] = useState(dashboardDummyData);
  ...
  return (
    <div>
      <Title
        ...
        font="outfit"
        title="Dashboard"
        subTitle="Monitor your room
      listings, track bookings and analyze revenue-all in one place. Stay updated with real-time
      ...
      <div
        ...
        <table className="w-full">
          ...
          <tbody className="text-sm">
              {dashboardDate.bookings.map((item,index) => (
                <tr key={index}>
