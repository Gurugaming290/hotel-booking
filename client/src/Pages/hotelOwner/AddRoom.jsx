...
const AddRoom = () => {
  ...
  return (
    <form>
      ...
      and accurate room details, pricing, and amenties, to enhance the user booking experience.'/>
      ...
      <div className='w-full flex max-sm:flex-col sm:gap-4 mt-4'>
        <div className='flex-1 max-w-48'>
          ...
          <select value={inputs.roomType} onChange={e=> setImages({...inputs,roomType: e.target.value})}
        ...
        <div>
          <p className='mt-4 text-gray-800'>
            ...
            rounded p-2 w-24' value={inputs.pricePerNight} onChange={e=> setInputs({...inputs,
