      ...
      <div className="py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32">
        ...
        <div className="flex flex-col md:flex-row md:justify-between mt-10">
          ...
          {/* CheckIn CheckOut Form */}
            ...
            bg-white shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-dull mx-auto mt-16 max-w-6xl">
              ...
              <div className="flex flex-col flex-wrap md:flex-row items-start md:items-center gap-4 md:gap-10 text-gray-500">
                  ...
                  <div className="flex flex-col">
                    ...
                    <input onChange={(e) =>setCheckInDate(e.target.value)} min={new Date().toISOString().split('T')[0]}
                     type="date" id="checkIndate" placeholder="Check-In" className="w-full
            ...
            <div className="max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500">
              <p >Guests will be allocated on the ground floor according to availability.
                ...
                according to availability. You get the comfortable two bedroom apartment that has a true city
                feeling.  
              </p>
            </div>
            ...
            <div className="flex flex-col items-start gap-4">
              <div className="flex gap-4">
                <img src={bed} alt="Host" className="h-14 w-14 md:h-18
