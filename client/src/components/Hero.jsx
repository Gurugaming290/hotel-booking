...
const Hero = () => {
    ...
    const onSearch = async (e) => {
      ...
      // add destination to SearchedCities max  recent searched cities 
  ...
  return (
    ...
    >
      <p className="bg-[#49B9FF]/50 px-3.5 py-1 rounded-full mt-20">
        The Ultimate Hotel Exprience
      </p>
      <h1
        className="font-playfair text-2xl md:text-5xl md:text-[56px] md:leading-14 
